...
sns_plot1 = sns.lineplot(x='timePacketReceived', y='rate', hue="flowID", data=df1)
sns_plot1.figure.tight_layout()
sns_plot1.get_figure().savefig("SPQ.png", dpi=400)
sns_plot1.get_figure().clf()
sns_plot2 = sns.set(style='darkgrid')
sns_plot2 = sns.lineplot(x='timePacketReceived', y='rate', hue="flowID", data=df2)
