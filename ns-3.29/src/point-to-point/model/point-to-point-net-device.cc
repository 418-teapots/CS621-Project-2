  ...
  uint16_t protocolNumber)
{
  ...
  //////  Experiment for match function.  //////
  // string packetStr1 = packet->ToString ();
  // cout << "packet to be enqueued: " << packetStr1 << endl;
...
uint32_t
PointToPointNetDevice::GetSrcPortNum (Ptr<Packet> packet) {
